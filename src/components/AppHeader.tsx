      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-1 text-sm font-semibold text-slate-600">
            <button
              onClick={onNavigateHome}
              className="px-3 py-2 rounded-lg text-forest-700 bg-forest-50 font-bold transition-colors cursor-pointer"
            >
              Chuyến đi của tôi
            </button>
            <button
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="absolute top-1 right-1 bg-bronze-600 text-white text-[10px] font-bold w-4.5 h-4.5 rounded-full flex items-center justify-center border-2 border-white">
                2
              </span>
            </button>
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-slate-200 p-4 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                  ...
                  <span className="text-xs text-bronze-600 font-semibold cursor-pointer hover:underline">
                    Đánh dấu đã đọc
                  </span>
                </div>
                <div className="space-y-3 py-3 text-xs">
                  <div className="p-2.5 rounded-xl bg-forest-50 border border-forest-100 space-y-1">
                  ...
                  <div className="p-2.5 rounded-xl bg-sand-50 border border-slate-100 space-y-1">
          ...
          <div className="relative">
            ...
            >
              <div className="w-9 h-9 rounded-full overflow-hidden border-2 border-bronze-600 shadow-sm">
                <img
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-60 bg-white rounded-2xl shadow-xl border border-slate-200 p-2 z-50 text-sm">
                ...
                <div className="py-1">
                  <button className="w-full text-left px-3 py-2 rounded-xl hover:bg-sand-50 flex items-center gap-2 text-slate-700 font-medium">
                ...
                <div className="border-t border-slate-100 pt-1">
                  <button className="w-full text-left px-3 py-2 rounded-xl hover:bg-red-50 text-bronze-600 flex items-center gap-2 font-medium">
