      ...
      <div className="bg-white rounded-[24px] max-w-sm w-full p-6 shadow-2xl border border-slate-200 text-left space-y-4 animate-fadeIn text-xs font-bold text-slate-700">
        ...
        <div className="relative">
          ...
          <button
            type="button"
            onClick={handleCopy}
            className="absolute right-2 top-2 p-1 text-slate-500 hover:text-[#DC2626] cursor-pointer"
        ...
        <div className="pt-2">
          <button
            type="button"
            onClick={handleCopy}
            className="w-full py-3 rounded-xl bg-[#DC2626] text-white font-extrabold text-xs shadow-md shadow-[#DC2626]/20 flex items-center justify-center gap-1.5 cursor-pointer"
          >
            {copied ? (
              <>
