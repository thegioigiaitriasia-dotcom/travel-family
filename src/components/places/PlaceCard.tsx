      ...
      >
        ...
        >
          ...
          {onSelect && (
            ...
            >
              <input type="checkbox" checked={isSelected} onChange={() => {}} className="rounded text-bronze-600" />
            </button>
          )}
        ...
        <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
          <div className="space-y-1.5">
            <div className="flex items-center justify-between gap-2">
              ...
              {place.visited && (
                <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-forest-100 text-forest-800 flex items-center gap-1">
            ...
            <h3
              onClick={() => onOpenDetail(place)}
              className="text-base font-black text-slate-900 hover:text-bronze-600 cursor-pointer tracking-tight leading-snug"
            >
              {place.name}
            </h3>
            ...
            {place.personalNote && (
              <p className="text-xs text-slate-600 line-clamp-2 bg-sand-50 p-2 rounded-xl border border-slate-100 italic">
                "{place.personalNote}"
              </p>
            )}
          </div>
          ...
          <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs gap-2">
            <div className="flex items-center gap-3">
              {place.personalRating && (
                <div className="flex items-center gap-1 text-bronze-600 font-extrabold">
                  <Star className="w-3.5 h-3.5 fill-amber-400 text-bronze-400" />
    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
        <div className="space-y-1.5">
              ...
              {showMenu && (
                ...
                >
                  <button
                    ...
                    className="w-full text-left px-3 py-2 hover:bg-sand-50 flex items-center gap-2"
                  >
                    <span>Chỉnh sửa</span>
                  </button>
                  <button
                  ...
                  <button
                    type="button"
                    onClick={() => onAddToTrip(place)}
                    className="w-full text-left px-3 py-2 hover:bg-sand-50 flex items-center gap-2 text-[#183B35]"
                  >
                    <span>Thêm vào chuyến đi</span>
                  </button>
          ...
          {place.personalNote && (
            <p className="text-xs text-slate-600 line-clamp-2 bg-sand-50 p-2.5 rounded-xl border border-slate-100 italic font-normal">
              "{place.personalNote}"
            </p>
          )}
